...
declare function convert-single-character-roman-numerals()
{
...
declare function convert-roman-numers-without-subtraction() 
{
...
declare function convert-roman-numbers-with-subtraction() 
{
...
declare function convert-int-to-roman-numeral() 
{
...
declare function throw-error-for-invalid-integers() 
{
...
declare function throw-error-for-invalid-roman-numerals() 
{
